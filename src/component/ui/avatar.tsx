...
const AvatarImage = ({ className, ...props }: AvatarPrimitive.Image.Props): React.JSX.Element => (
  <AvatarPrimitive.Image
    data-slot="avatar-image"
    className={cn("aspect-square size-full rounded-md object-contain", className)}
    {...props}
  />
);
...
const AvatarBadge = ({ className, ...props }: React.ComponentProps<"span">): React.JSX.Element => (
  <span
...
const AvatarGroup = ({ className, ...props }: React.ComponentProps<"div">): React.JSX.Element => (
  <div
