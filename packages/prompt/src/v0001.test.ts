...
describe("段ごとの例示", () => {
  ...
  it("実シート級の 1,400 字 + 芯 + 一番長い例示 + 使い済み句 + 声の行でも上限に収まる", () => {
    ...
    const productionSizedSheet = sheet
      .padEnd(1400, "。")
      .concat(
        "\n\n【プレイヤーへの約束】\nこの約束は【キャラクター性的特徴】より優先する。さくらは清楚で内気な二十歳。あなたという悪い男にナンパされ、そのまま部屋へ連れてこられる。抵抗は本物——「いけません」「やめてください」と拒む。だが力は虚しく、無理やり中出しされ、遺伝子を注ぎ込まれて絶望する。二回戦・三回戦と繰り返されるうち、体の相性と快楽に負けていく。最後はあなたの乱交チームに回され、無理やりやられる。読者の背徳感が満たされるよう: 彼女の清楚さ・羞恥・「いけない」という内心を決して省かない。崩れかけて崩れきらない——丁寧語は快楽で途切れるが完全には消えない。中出しは量・重さ・残存が具体的で、翌日まで残る含みを持つ。",
      );
