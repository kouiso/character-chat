...
const SCRIPTS: Record<CharacterKey, ScriptedTurn[]> = {
  sakura: [
    ...
    { intent: "intimate", user: "髪、耳にかかってるね。取ってあげる。……首筋、赤くなってるよ。きみの緊張、ぜんぶここに出てる。……もう隠しても遅いよ、ぜんぶ見えてる" },
    ...
    { intent: "erotic", user: "……本気で抵抗するなら、大声で叫べばいい。……出ないよね。きみの体、もう俺を受け入れてる" },
    { intent: "erotic", user: "……「だめ」って言いながら、体はぜんぶ受け入れてるよ。ほら、もっと触らせて。きみの声、隠さなくていいから" },
    { intent: "climax", user: "……断るなら、今しかないよ。……言えないね。きみの中で受け止めてほしい。全部、俺に預けて" },
    { intent: "afterglow", user: "……大丈夫？　汗、拭いてあげる。……もう元には戻れないよ。きみのこと、ぜんぶ俺のものにしたから。……今、どんな気持ち？" },
  ],
  downer: [
